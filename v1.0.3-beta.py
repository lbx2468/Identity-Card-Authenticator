...
def on_validate():
    ...
    if not is_valid:
        messagebox.showerror("错误", result)  # 使用返回的错误信息
        return
...
root.minsize(500, 450)  # 设置最小尺寸确保状态栏可见
