...
| 版本 | 主要变更                                                |
|------|---------------------------------------------------------|
| v1.0.0-beta  | 初始实现身份证验证系统，使用Excel存储数据           |
...
| v1.1.0-beta  | 移除Excel依赖，使用data.py存储数据，简化查找函数    |
| v1.1.1-beta  | 优化出生日期格式为"1970年1月1日"（去除前导零）      |
| v1.1.2-beta  | 为验证按钮添加鼠标悬停高光效果                     |
| v1.1.3-beta  | 优化代码注释，增加可读性                           |
| v1.1.4-beta  | 更新稳定版，综合所有优化，完善错误处理              |
